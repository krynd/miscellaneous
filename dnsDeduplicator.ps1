<#
From https://blogs.technet.microsoft.com/askpfe/2011/06/03/how-dns-scavenging-and-the-dhcp-lease-duration-relate/
#>
...
$duplicate_comp | select-object name,ipv4address

# Write all duplicate computers to a file for easy parsing
$duplicate_comp | select-object name,ipv4address | export-csv [PSDrive]:\[directories]\duplicateDNS.log -Append
